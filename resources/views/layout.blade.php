...
<html lang="vi">
   <head>
      ...
      <link rel="shortcut icon" href="https://i.ibb.co/RDRvt94/logo.png" type="image/x-icon" src="{{asset('img/logo.png')}}" />
      ...
      <style>#header .site-title {background: url(https://i.ibb.co/RDRvt94/logo.png) no-repeat top left;background-size: contain;text-indent: -9999px; height: 100px;}</style>
   </head>
   <body class="home blog halimthemes halimmovies" data-masonry="">
                     ...
                     <ul id="menu-menu_1" class="nav navbar-nav navbar-left">
                        ...
                        <li class="mega dropdown">
                           ...
                           <ul role="menu" class="dropdown-menu">
                              ...
                              <li>
                                 <a title="{{$con->title}}" href="{{route('country',$con->slug)}}">{{$con->title}}</a>
                              </li>
                              @endforeach
                           </ul>
                        </li>
            ...
            <div class="row container">
               <div class="widget about col-xs-12 col-sm-4 col-md-4">
                  <div class="footer-logo">
                     <img class="img-responsive" src="{{asset('img/logo.png')}}" alt="Phim hay 2021- Xem phim hay nhất" />
                  </div>
                  Liên hệ QC: <a href="/" class="__cf_email__" data-cfemail="e5958d8c888d849ccb868aa58288848c89cb868a88">tronghienne@gmail.com</a>
                  <br/>
                  Số điện thoại: <a href="/" class="__cf_email__" data-cfemail="e5958d8c888d849ccb868aa58288848c89cb868a88">0941945167</a>
               </div>
            </div>
         </div>
      </footer>
      ...
      <div id="fb-root"></div>
      <script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v14.0" nonce="pO8DX1ia"></script>
               ...
               if(search!=''){
                  ...
                  $.getJSON('/json/movies.json', function(data){
                     $.each(data, function(key, value){
                        ...
                        {
                           $('#result').append('<li style="cursor:pointer; display: flex; max-height: 200px;" class="list-group-item link-class"><img src="public/uploads/movies/'+value.image+'" width="50" class="" /><div style="flex-direction: column; margin-left: 2px;"><h4 width="100%">'+value.title+'</h4><span style="display: -webkit-box; max-height: 8.2rem; -webkit-box-orient: vertical; overflow: hidden; text-overflow: ellipsis; white-space: normal; -webkit-line-clamp: 5; line-height: 1.6rem;" class="text-muted">| '+value.description+'</span></div></li>');
                        }  
                     });
                  })
               }else{
      ...
      <script>
         ...
         owl.owlCarousel({loop: true,margin: 5,autoplay: true,autoplayTimeout: 2000,autoplayHoverPause: true,nav: true,navText: ['<i class="hl-down-open rotate-left"></i>', '<i class="hl-down-open rotate-right"></i>'],responsiveClass: true,responsive: {0: {items:2},480: {items:3}, 600: {items:5},1000: {items: 5}}})});
      </script>
